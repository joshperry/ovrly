...
class UIHandler : public CefClient,
 ...
 public:
  explicit UIHandler(bool use_views)
  ...
  void CloseAllBrowsers(bool force_close) {
    if (!CefCurrentlyOn(TID_UI)) {
      ...
      CefPostTask(TID_UI, base::Bind(&UIHandler::CloseAllBrowsers, this,
                                     force_close));
      return;
    }
...
void launchui() {
  ...
  // UI browser handler
  CefRefPtr<UIHandler> handler(new UIHandler(useviews));
...
/**
 * Callback for process:hookBrowser
 *
